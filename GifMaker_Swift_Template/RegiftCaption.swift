...
extension Regift {
  ...
  func addCaption(_ image: CGImage, text: NSString, font: UIFont) -> CGImage {
    ...
    var attributes = [kCTForegroundColorAttributeName:color, kCTFontAttributeName:font, kCTStrokeColorAttributeName : UIColor.black, kCTStrokeWidthAttributeName : -4] as [NSAttributedStringKey : Any]
